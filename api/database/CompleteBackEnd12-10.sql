...
/****** Object:  Database [final_capstone]    Script Date: 12/10/2020 11:20:49 AM ******/
...
USE [final_capstone]
GO
/****** Object:  Table [dbo].[addresses]    Script Date: 12/10/2020 11:20:50 AM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[appointments]    Script Date: 12/10/2020 11:20:50 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[daysOfTheWeek]    Script Date: 12/10/2020 11:20:50 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[doctor]    Script Date: 12/10/2020 11:20:50 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[doctor_day]    Script Date: 12/10/2020 11:20:50 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[office]    Script Date: 12/10/2020 11:20:50 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[office_day]    Script Date: 12/10/2020 11:20:50 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[officeReviews]    Script Date: 12/10/2020 11:20:50 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[patients]    Script Date: 12/10/2020 11:20:50 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[reviewResponses]    Script Date: 12/10/2020 11:20:50 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[users]    Script Date: 12/10/2020 11:20:50 AM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[office]  WITH CHECK ADD  CONSTRAINT [FK_office_addresses] FOREIGN KEY([addressId])
REFERENCES [dbo].[addresses] ([addressId])
GO
ALTER TABLE [dbo].[office] CHECK CONSTRAINT [FK_office_addresses]
GO
...
GO
ALTER TABLE [dbo].[patients]  WITH CHECK ADD  CONSTRAINT [FK_patients_addresses] FOREIGN KEY([addressId])
REFERENCES [dbo].[addresses] ([addressId])
GO
ALTER TABLE [dbo].[patients] CHECK CONSTRAINT [FK_patients_addresses]
GO
